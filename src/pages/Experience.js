    ...
    return (
        <div name="experience" className="flex flex-col align-center">
            ...
            <div className="lg:flex gap-10">
              ...
              <div className="text-center shadow-lg p-10 rounded-xl dark: bg-white" style={{ display: "flex", flexDirection: "column", alignItems: "center", height: "70vh", width: "50vh" }}>
                <Image className="hover:scale-110 duration-500" src={metalogo} height={100} width={100} />
                ...
                <ul className="list-disc text-left">
                  ...
                  <li className="py-1 text-gray-600 text-md font-medium">Implemented an improved API for a new version of Dataswarm, a Python framework for building data pipelines. </li>
